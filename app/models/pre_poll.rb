class PrePoll < ApplicationRecord
  ...
  after_update_commit ->(pre_poll) {
                        # broadcast_update_to "editor", target: "editor_form", partial: "pre_polls/form",
                        #                              locals: { pre_poll: pre_poll }
                        #broadcast_replace_to "proposer", target: "pre_poll_result", partial: "pre_polls/table",
                        #                                 locals: { pre_poll: pre_poll }
                      }
end
